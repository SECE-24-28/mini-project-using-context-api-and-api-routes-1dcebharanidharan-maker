  ...
  return (
    <Card className="border-white/10 bg-white/5 backdrop-blur">
      <CardHeader>
        ...
        <CardDescription className="text-center text-gray-400">Sign in to your workspace</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        <Button variant="outline" className="w-full border-white/20 text-white hover:bg-white/10" onClick={handleGoogle}>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <Button type="submit" className="w-full bg-indigo-500 hover:bg-indigo-600" loading={loading}>Sign in</Button>
        </form>
